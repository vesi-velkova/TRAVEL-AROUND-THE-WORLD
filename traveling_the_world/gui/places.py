...
GOOGLE_MAPS_API_KEY = 'AIzaSyCc5O4Bo6DzGk0dVKd0CeN-4jlYRNQVt_o'
...
class PlacesUtilities:
    ...
    def find_places_given_place_type_and_radius(self, place, radius, type = ""):
        ...
        if type == '':
            ...
            query = type + ' in ' + place
        parameters = {'query':query, 'radius': radius, 'key':GOOGLE_MAPS_API_KEY}
...
print(PlacesUtilities().find_biggest_cities_by_country_name('The Isle of Man'))